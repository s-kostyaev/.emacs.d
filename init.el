...
(use-package ultra-scroll
  :preface
  (my-vc-install :name "ultra-scroll" :host "github" :repo "jdtsmith/ultra-scroll")
  :init
...
(use-package ellama
  ...
  (setopt ellama-provider
	  (make-llm-openai-compatible
	   ...
	   :chat-model "Qwen3.6-27B-Abliterated-Heretic-Uncensored-MLX-3bit" ;; "Qwen3.6-35B-A3B-UD-MLX-3bit" ;; "Qwen3.6-35B-A3B-4bit" ;; "Qwen3.6-27B-MLX-4bit-MTP" ;; "gemma-4-26b-a4b-it-4bit"
...
")
  ...
  (load-file "~/elisp/ellama/ellama-tools-dlp.el")
