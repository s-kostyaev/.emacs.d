...
(custom-set-variables
 ...
 '(package-selected-packages
   '(envrc haskell-mode wgrep breadcrumb ellama zenburn-theme xeft white-sand-theme web-beautify vterm-toggle vmd-mode visual-regexp treesit-auto timp tagedit symbol-overlay string-inflection spray speed-type speechd-el spacious-padding spacemacs-theme solarized-theme smart-shift rust-playground rust-mode reverse-im restclient-jq rainbow-mode pyenv-mode pulsar protobuf-mode prism poly-markdown plz pkgbuild-mode pass pandoc-mode package-lint-flymake org-mind-map ocp-indent nova-theme nov noflet multiple-cursors monokai-theme merlin marginalia magit-todos leetcode keycast key-chord kaolin-themes jsonian json-snatcher json-rpc ibuffer-vc hungry-delete highlight-indentation hercules haskell-snippets go-tag go-snippets go-playground go-impl go-gen-test go-fill-struct git-timemachine gif-screencast frimacs flymake-quickdef flymake-proselint flymake-go-staticcheck flx feature-mode fb2-reader expand-region embark-consult elisp-benchmarks ein eglot-fsharp ef-themes edit-server edit-indirect eat dune dumb-jump dtrt-indent dotnet dockerfile-mode docker-compose-mode denote dash-functional dart-mode dape corfu consult-dash conda composable comment-tags cl-libify chocolate-theme cask-mode cargo bash-completion auto-yasnippet auctex apparmor-mode ample-theme aggressive-indent ace-link))
 '(reverse-im-input-methods '("russian-computer"))
 '(safe-local-variable-values '((conda-project-env-path . "pineapple"))))
