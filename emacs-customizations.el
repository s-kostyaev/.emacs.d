...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (which-key ace-window ace-link ensime popup sbt-mode scala-mode smartparens viking-mode cmake-font-lock cmake-mode cmake-ide levenshtein xref-js2 xah-lookup wgrep web-mode speed-type smex smart-mode-line slime-company rtags quelpa pandoc-mode monokai-theme markdown-mode lua-mode link-hint key-chord js2-refactor ivy-hydra ivy-erlang-complete go-impl go-eldoc geiser flycheck-gometalinter flycheck-dialyzer flx fill-column-indicator expand-region eopengrok emmet-mode counsel-projectile company-irony-c-headers company-irony company-go company-anaconda color-theme-solarized ace-mc ac-js2)))
