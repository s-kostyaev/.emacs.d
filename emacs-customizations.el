...
(custom-set-variables
 ...
 '(package-selected-packages
   '(embark-consult company-restclient restclient-jq leetcode denote ef-themes jsonian pulsar merlin ocp-indent tuareg dotnet dash-docs frimacs project-rootfile vterm vterm-toggle fb2-reader csharp-mode origami lsp-origami ein lsp-haskell haskell-mode haskell-snippets dap-mode affe eglot-fsharp fsharp-mode tree-sitter tree-sitter-langs rase company-maxima posframe speechd-el apparmor-mode golden-ratio visual-fill-column justify-kp nov spray embark marginalia consult consult-lsp languagetool visual-regexp cl-libify auctex maxima flx leaf-convert leaf expand-region flymake-proselint flymake-quickdef package-lint-flymake rainbow-mode orderless go-translate lsp-mode lsp-pyright vterm comby elisp-benchmarks protobuf-mode dumb-jump vmd-mode dockerfile-mode pkgbuild-mode rg cargo rust-playground rust-mode string-inflection prism poly-markdown gif-screencast keycast fzf hercules white-sand-theme yasnippet benchmark-init magit kaolin-themes company-prescient chocolate-theme git-timemachine dart-mode nova-theme zenburn-theme solarized-theme flymake ample-theme flymake-go-staticcheck package-lint auto-yasnippet pass password-store ace-window ace-link symbol-overlay composable multiple-cursors go-playground gotest dtrt-indent magit-todos aggressive-indent reverse-im bash-completion pcre2el eglot pyenv-mode go-snippets smart-shift highlight-indentation go-fill-struct edit-server go-tag go-gen-test comment-tags org-mind-map json-snatcher docker-compose-mode feature-mode zygospore hungry-delete ibuffer-vc xah-lookup which-key wgrep web-beautify timp tagedit speed-type spacemacs-theme pandoc-mode noflet monokai-theme key-chord json-rpc jquery-doc go-impl edit-indirect company-quickhelp cask-mode))
