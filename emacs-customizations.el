...
(custom-set-variables
 ...
 '(package-selected-packages
   '(amx icomplete-vertical orderless posframe go-translate modus-operandi-theme modus-vivendi-theme lsp-mode lsp-pyright vterm comby elisp-benchmarks tree-sitter-langs tree-sitter protobuf-mode dumb-jump vmd-mode dockerfile-mode pkgbuild-mode rg cargo rust-playground rust-mode string-inflection prism rainbow-mode poly-markdown gif-screencast keycast fzf hercules white-sand-theme organic-green-theme yasnippet benchmark-init magit kaolin-themes company-prescient chocolate-theme git-timemachine dart-mode nova-theme reason-mode zenburn-theme magit-libgit solarized-theme use-package flymake libgit ample-theme flymake-go-staticcheck package-lint auto-yasnippet pass password-store ace-window ace-link exec-path-from-shell symbol-overlay composable multiple-cursors helm-make go-playground gotest dtrt-indent magit-todos aggressive-indent reverse-im wgrep-helm moe-theme bash-completion pcre2el eglot docker-tramp pyenv-mode go-snippets smart-shift highlight-indentation go-fill-struct edit-server ace-jump-helm-line go-tag go-gen-test comment-tags org-mind-map ace-isearch json-snatcher docker-compose-mode go-direx feature-mode zygospore hungry-delete ibuffer-vc use-package-chords xah-lookup which-key wgrep web-beautify timp tagedit speed-type spacemacs-theme smex pandoc-mode noflet monokai-theme key-chord json-rpc jquery-doc go-impl flx embrace edit-indirect company-quickhelp cask-mode))
