...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-link aggressive-indent ample-theme apparmor-mode auto-yasnippet
	      ...
	      flymake-quickdef frimacs futur gif-screencast git-timemachine
	      go-fill-struct go-gen-test go-impl go-snippets go-tag gotest
	      haskell-ts-mode hercules highlight-indentation hungry-delete
	      ibuffer-vc idlwave json-rpc json-snatcher jsonian jsonrpc
	      key-chord keycast magit-todos marginalia mcp merlin monokai-theme
	      multiple-cursors neocaml noflet nov nova-theme ob-go ocp-indent
	      org org-mind-map outline-indent package-lint-flymake pandoc-mode
	      pass pdf-tools peg pkgbuild-mode plz poly-markdown posframe prism
	      project protobuf-mode pulsar pyenv-mode python rainbow-mode
	      restclient-jq reverse-im rust-mode rust-playground smart-shift
	      soap-client solarized-theme spacemacs-theme spacious-padding
	      speechd-el speed-type spray string-inflection symbol-overlay tabby
	      tagedit timp track-changes tramp transient treesit-auto
	      treesit-fold ultra-scroll use-package verilog-mode visual-regexp
	      vmd-mode vterm-toggle web-beautify web-mode wgrep which-key
